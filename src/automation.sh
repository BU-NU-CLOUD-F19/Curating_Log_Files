...
if grep -c "58 23 * * * /root/automation_journalctl.sh" /var/spool/cron/root; then echo "Entry already in crontab"; else echo "58 23 * * * /root/automation_journalctl.sh" >>  /var/spool/cron/root; fi
